        ...
        <div className="h-screen w-screen flex items-center justify-center">
            <Card className="max-w-[400px] w-full mx-auto">
                <CardContent className="p-6 flex flex-col w-full items-center">
                    ...
                    <p className="text-sm text-muted-foreground text-center mt-1">We sent you a calendar invitation with all the details of the meeting and a video call link</p>
                </CardContent>
